...
const storyParts = [
    "Who could've thought i'd get the chance to meet a beautiful soul ",
    ...
    "My Lilly ip in a garden of roses.",
    ...
    "<span class='story-text final'>MARIA, my beautiful pretty girl with a heart as deep as the stories you love—Will you be my Big Dawwwg?</span>"
];
...
noBtn.addEventListener('click', () => {
    ...
    storyContent.innerHTML = `
        <p class="story-text final">
            ...
            "She was cursed to drink 17 shots of KC Smooth dry no chaser for the rest of time.'"<br><br>
